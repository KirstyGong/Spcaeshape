...
public abstract class Shape {
	...
	/**
	 * The template method pattern for painting
	 * @param painter the Painter object for drawing
	 */
	...
	/**
	 * Add in the text want to display in shape.
	 * @param text text
	 */
	...
	/**
	 * Returns the CarrierShape that contains the Shape that method parent is called on.
	 * @return
	 */
	...
	/**
	 * It return the list of path of the object that call this method from the roots to itself.
	 * @return path list.
	 */
